...
We have recently written a paper titled "Analyzing interval-censored data in agricultural research: a review with examples and code snippets" (Annals of Applied biology, in press.; [doi.org/10.1111/aab.12477](https://doi.org/10.1111/aab.12477) ). In that paper we noted that *survival analysis* has mostly been overlooked in agricultural research. This is not because censored data are not found in agriculture. Indeed, a survey of literature in agronomy and related disciplines shows several examples where individual traits cannot be measured with high precision. Their values need to be represented by uncertainty intervals into which the real values fall. Therefore, these measures are censored. Here are some examples we mention in the paper: 
...
This webpage aims to provide the commented R code and the datasets to reproduce all the analyses and results described in the main paper  (Annals of Applied biology, in press.; [doi.org/10.1111/aab.12477](https://doi.org/10.1111/aab.12477) ). We also give some extra hints, to open up other possibilities, not considered in the paper. Our hope is that, whenever censored data are recognised, the correct techniques are used more extensively. 
